...
void UAO_DummyCustomComponent::SaveCustomizingData()
{
	...
	// 추가: 실제 플레이어 캐릭터 외형에도 적용 요청
	if (UAO_CustomizingComponent* CustomizingComp = Player->GetCustomizingComponent())
	{
		CustomizingComp->ServerRPC_ChangeCustomizing(CustomizingData);
	}//REP-02
}
